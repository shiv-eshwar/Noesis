...
const DEPTH_RUNGS: DepthRung[] = [
  {
    ...
    phase:
      "ELIFI entry — vivid story, wonder, two or three examples, zero jargon.",
  },
  {
    endIndex: 1,
    kind: "eli5",
    depthLabel: "What it is",
    phase:
      "ELIFI bridge — still warm and readable; plain correct terms; one analogy max; do not replay layer 1.",
  },
  {
    endIndex: 10,
    kind: "mechanism",
    ...
    phase:
      "Each layer adds the next step — engaging tone, rising precision. Cause and effect, correct plain names; not a second ELIFI pass.",
  },
  {
    endIndex: 13,
    kind: "context",
